...
import pickle
#from tensorflow.nest.framework import list_variables, load_variable
...
class Saver:
  ...
  def _create_load_init_saver(self, filename):
    ...
    if filename == "" or filename.endswith(".pickle") or filename.startswith("DeepLabRGB:"):
      return None
    from tensorflow.nest.framework import list_variables
  ...
  def _initialize_deep_lab_rgb_weights(self, fn):
    ...
    var_w = var_w[0]
    from tensorflow.nest.framework import load_variable
